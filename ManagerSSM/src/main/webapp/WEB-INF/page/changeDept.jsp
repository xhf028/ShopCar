	...
	<div class="left-nav">
		<div id="side-nav">
			<ul id="nav">
				...
				</a><a href="deptList"> <i class="iconfont">&#xe723;</i> <cite>部门管理</cite>
						<i class="iconfont nav_right">&#xe697;</i>
				</a></li>
						...
						<form class="layui-form" method="POST" id="deptForm"
							...
							<input type="hidden" name="id" id="id" value="${dept.id }">
								...
								<label for="username" class="layui-form-label"> <span
									class="x-red">*</span>部门Id
								</label>
								<div class="layui-input-inline">
									<input type="text" id="id" name="id" required=""
										lay-verify="required" autocomplete="off" class="layui-input"
										value="${dept.id}" disabled="disabled">
								</div>
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-inline">
									<input type="text" id="name" name="name" required=""
										lay-verify="required" autocomplete="off" class="layui-input"
										value="${dept.name }" disabled="disabled">
								</div>

							</div>
							<div class="layui-form-item">
								<label for="phone" class="layui-form-label"> <span
									class="x-red">*</span>详细信息
								</label>
								<div class="layui-input-inline">
							...
							<div class="layui-form-item">
								<label for="L_repass" class="layui-form-label"> </label> <input
									...
									lay-submit="" />
									<input
									type="reset" value=" 重置" class="layui-btn" lay-filter="add"
									lay-submit="" />
