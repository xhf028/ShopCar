...
<ul class="layui-nav right" lay-filter="">
		...
		<div id="side-nav">
			<ul id="nav">
				<li id="aaa"><a href="list" > <i class="iconfont">&#xe6b8;</i> <cite>员工管理</cite>
						...
						<i class="iconfont nav_right">&#xe697;</i>
				</a><a href="deptList" id="aaa"> <i class="iconfont">&#xe723;</i>
	...
	<div class="page-content">
		<div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
			<ul class="layui-tab-title">
				<li class="home"><i class="layui-icon">&#xe68e;</i>用户列表</li>
			</ul>
		...
		<div class="layui-row" style="" align="center">
          ...
          <input class="layui-input" placeholder="截止日" name="end" id="end"> -->
				...
				<a class="layui-btn" href="selectActionUser">活动用户</a>
				</input>
			</form>
		</div>
		<%-- <xblock>
 <!--        <button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>批量删除</button> -->
		...
		<table class="layui-table">
			...
			<tbody>
				<c:forEach items="${actionUserList}" var="listU" >
					<tr>
						<td>
