<%@page import="com.ssm.common.bean.Book"%>
...
<body>
	...
	<div class="login_tip"><span class=" glyphicon glyphicon-info-sign">&nbsp;</span>依据《网络安全法》，为保障您的账户安全和正常使用，请尽快完成手机号验证，将更有利于保护您的个人隐私。</div>
	<div class="login_bg row">
		<div class="login_body col-md-7 column">
			<img src="./static/images/bg_login.png">
		</div>
		<div class="login_box col-md-3 column">
			<h1>账号登录</h1>
			<h2>公共场所请不要泄露您的密码，以防止账号丢失</h2>
			<form action="index" class="form-horizontal" role="from" method="post">
				
				<div class=" form-group">
					<div class="input-group ">
						<span class="input-group-addon glyphicon glyphicon-user"></span> <input type="text" name="username"
