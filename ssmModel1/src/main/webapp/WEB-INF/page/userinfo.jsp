    					...
    					<!--从session获取登陆时的数据 -->
    					 <%Customer customer = (Customer)session.getAttribute("customer");  
    						...
    						<li>
    								...
    								<input id="J_euserName" class="long" readonly="readonly" name="username"   value=<%=customer.getUsername() %> type="text"  />
    						...
    						<li>
    								<input id="J_euserName" class="long" name="password"  value=<%=customer.getPassword() %>    type="text"   readonly="readonly" />
    						...
    						<li>
    								<input id="J_euserName" class="long" name="zip"  value=<%=customer.getZip() %>   type="text" />
    						...
    						<li>
    								<input id="J_euserName" class="long" name="address"  value=<%=customer.getAddress() %>   type="text" />
    						...
    						<li>
    								<input id="J_euserName" class="long" name="phone"  value=<%=customer.getPhone() %>  type="text" />
    						...
    						<li>
    								<input id="J_euserName" class="long" name="email" value=<%=customer.getEmail() %>  type="text" />
