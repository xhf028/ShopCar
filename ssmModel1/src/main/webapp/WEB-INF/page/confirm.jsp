...
<body>
	...
	<div class="nav">
		...
		<div class="body">
				...
				<div class="row">
					<form class="form-horizontal col-md-7 column" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" disabled="disabled"  value="江苏省苏州市常熟市常熟理工学院" />
							</div>
						</div>
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-4 control-label">收货人电话：</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" disabled="disabled"  value="1888888888" />
							</div>
						</div>
					</form>
				</div>
					...
					<div class="twoDiv row">
						...
						<div class="col-md-9  column order-message">
							<div class="row"> 
								...
								<font class="col-md-3  column">¥ 81.00</font>
								<font class="col-md-3  column">×1</font>
			...
			<div class="allButtom">
				<p class="caozuo">
					<a href="confirm.html">订单确认</a>
				</p>
				<span>共<font id="book-num" style="color: #b11e22;">2</font>件商品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;应付：¥<font
